  ...
  return (
    <div className='relative'>
      <label className="flex flex-row">
        <input
          {...props}
          {...(props.className ? { className: props.className } : { className: "w-full border border-gray-300 rounded-3xl px-4 py-2 focus:outline-none focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40"})}
